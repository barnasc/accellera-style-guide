...
Letter symbols defined in applicable IEEE standards (see [Clause 2](02.md)) should be used in preparing mathematical expressions. (See [14.4](14.md#144-letter-symbols) for a discussion of letter symbols.)
